    ...
    <div className="h-full flex-1 flex items-center justify-center">
      <div className="px-4 w-sm sm:w-1/2 flex flex-col items-center gap-10">
        ...
        <div className="w-3/4 sm:w-full flex flex-col sm:flex-row items-center justify-between gap-4 p-4">
          ...
          <Button className="w-56 flex items-center justify-between bg-brand-200 hover:bg-brand-200/80 hover:cursor-pointer text-lg font-semibold px-7 py-4">
          ...
          <Button
            variant="outline"
            className="w-56 flex items-center justify-between hover:cursor-pointer text-lg font-semibold px-7 py-4"
          >
