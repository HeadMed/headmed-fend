    ...
    <main className='h-dvh w-dvw bg-brand-200 flex justify-end'>
      <div className='h-full w-[550px] bg-brand-50 shadow-xl shadow-black flex flex-col justify-center'>
        <Card className='bg-transparent shadow-none border-none'>
          <CardHeader>
            <h1 className='text-4xl text-center font-bold text-brand-200'>Cadastro</h1>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            <CardContent>
              ...
              <div>
                <Label htmlFor='confirmPassword' className='text-md text-brand-dark mb-3'>
                  Confirmar Senha
                </Label>
                <Input
                  id='confirmPassword'
            ...
            <CardFooter className='flex flex-col items-center mt-6 gap-4'>
              ...
              <p className='text-sm text-brand-dark'>
                Já tem uma conta?{' '}
                <Link href='/auth/login' className='text-brand-200 hover:underline'>
                  Faça login
                </Link>
              </p>
            </CardFooter>
