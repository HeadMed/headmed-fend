  ...
  return (
    <section className="flex flex-col justify-center items-center w-full h-auto py-10 bg-transparent">
      <div className="flex flex-col items-center justify-around gap-6 w-3/4 px-4">
        ...
        <p className="text-zinc-500 text-xl font-light w-md sm:w-[690px] text-center ">
        ...
        <ul className="grid grid-cols-2 grid-rows-2 sm:flex sm:flex-row justify-between items-center w-xl text-center">
          <li>
